classdef TXClass < handleHidden
%% TXClass  Class storing properties for transmission to coil
%
% constructor:
%   TXobj = PD.TXClass(HW)
%
% Input:
%   HW      object of class PD.HWClass
%
% TX properties:
...
%   ExtRFType           string with type identifier for external rf amplifier
%
