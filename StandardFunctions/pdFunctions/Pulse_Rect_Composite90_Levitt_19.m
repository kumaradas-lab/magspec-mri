function [pulseData] = Pulse_Rect_Composite90_Levitt_19(HW, Center, Pulse, varargin)
%% Create a composite 90 degree RF pulse as described in Levitt et al. [19]
%
%   pulseData = Pulse_Rect_Composite90_Levitt_19(HW, Center, Pulse)
% or:
%   pulseData = Pulse_Rect_Composite90_Levitt_19(HW, Center, Bandwidth, FlipAngle, MaxNumberOfSegments, MaxLength, Frequency, Phase)
% additionally:
%   excitationAngleFactor = Pulse_Rect_Composite90_Levitt_19(HW, 'Amp')
%   bandwidthFactor = Pulse_Rect_Composite90_Levitt_19(HW, 'Time')
%
% This is the composite pulse described in reference [19] of the chapter
...
%   M. H. Levitt, J. Magn. Reson., 1982, 48, 234.
% From Table 1 (Variable Rotation Composite 90 DEG pulses):
%   rel. B1 bandwidth: {0.62, 1.37}   (1 is nominal)
%   rel. B0 bandwidth: {-0.13, 0.10}  (0 is nominal)
%
%
% INPUT:
%
...
%% composite settings
FlipAngleComposite = [90; 180];
FlipPhaseComposite = [ 0; 120];
