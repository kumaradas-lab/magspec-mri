function [pulseData] = Pulse_Sinc_3(HW, Center, Pulse, varargin)
%% Create a sinc pulse with three side lobes
%
...
pulseDuration = numberOfZeroCrossings/Pulse(1).Bandwidth;  % duration of the whole pulse
