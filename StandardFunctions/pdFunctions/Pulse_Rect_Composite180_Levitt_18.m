function [pulseData] = Pulse_Rect_Composite180_Levitt_18(HW, Center, Pulse, varargin)
%% Create a composite 180 degree RF pulse as described by Levitt et al. [18]
%
%   pulseData = Pulse_Rect_Composite180_Levitt_18(HW, Center, Pulse)
% or:
%   pulseData = Pulse_Rect_Composite180_Levitt_18(HW, Center, Bandwidth, FlipAngle, MaxNumberOfSegments, MaxLength, Frequency, Phase)
% additionally:
%   excitationAngleFactor = Pulse_Rect_Composite180_Levitt_18(HW, 'Amp')
%   bandwidthFactor = Pulse_Rect_Composite180_Levitt_18(HW, 'Time')
%
...
%   rel. B1 bandwidth: {0.67, 1.09}   (1 is nominal)
%   rel. B0 bandwidth: {-0.52, 0.52}  (0 is nominal)
%
%
% INPUT:
%
...
%% composite settings
FlipAngleComposite = [90; 240; 90];
FlipPhaseComposite = [ 0;  90;  0]-90;
