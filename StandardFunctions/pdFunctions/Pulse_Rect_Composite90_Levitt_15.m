function [pulseData] = Pulse_Rect_Composite90_Levitt_15(HW, Center, Pulse, varargin)
%% Create a composite 90 degree RF pulse as described in Levitt et al. [15]
%
%   pulseData = Pulse_Rect_Composite90_Levitt_15(HW, Center, Pulse)
% or:
%   pulseData = Pulse_Rect_Composite90_Levitt_15(HW, Center, Bandwidth, FlipAngle, MaxNumberOfSegments, MaxLength, Frequency, Phase)
% additionally:
%   excitationAngleFactor = Pulse_Rect_Composite90_Levitt_15(HW, 'Amp')
%   bandwidthFactor = Pulse_Rect_Composite90_Levitt_15(HW, 'Time')
%
...
%   rel. B0 bandwidth: {-0.88, 0.36}  (0 is nominal)
%
%
% INPUT:
%
...
%% composite settings
FlipAngleComposite = [180;     360;   180;     90];
FlipPhaseComposite = [291.5/3; 291.5; 291.5/3; 0 ];
