function [pulseData] = Pulse_Rect_Composite180_Levitt_19(HW, Center, Pulse, varargin)
%% Create a composite 180 degree RF pulse as described by Levitt et al. [19]
%
%   pulseData = Pulse_Rect_Composite180_Levitt_19(HW, Center, Pulse)
% or:
%   pulseData = Pulse_Rect_Composite180_Levitt_19(HW, Center, Bandwidth, FlipAngle, MaxNumberOfSegments, MaxLength, Frequency, Phase)
% additionally:
%   excitationAngleFactor = Pulse_Rect_Composite180_Levitt_19(HW, 'Amp')
%   bandwidthFactor = Pulse_Rect_Composite180_Levitt_19(HW, 'Time')
%
...
%   rel. B1 bandwidth: {0.71, 1.29}   (1 is nominal)
%   rel. B0 bandwidth: {-0.08, 0.08}  (0 is nominal)
%
%
% INPUT:
%
...
%% composite settings
FlipAngleComposite = [90; 360;  90];
FlipPhaseComposite = [ 0; 120;   0];
