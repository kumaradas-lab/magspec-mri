function [pulseData] = Pulse_Rect_Composite180_Levitt_33(HW, Center, Pulse, varargin)
%% Create a composite 180 degree RF pulse as described in Levitt et al. [33]
%
%   pulseData = Pulse_Rect_Composite180_Levitt_33(HW, Center, Pulse)
% or:
%   pulseData = Pulse_Rect_Composite180_Levitt_33(HW, Center, Bandwidth, FlipAngle, MaxNumberOfSegments,  MaxLength, Frequency, Phase)
% additionally:
%   excitationAngleFactor = Pulse_Rect_Composite180_Levitt_33(HW, 'Amp')
%   bandwidthFactor = Pulse_Rect_Composite180_Levitt_33(HW, 'Time')
%
...
%% composite settings
FlipAngleComposite = [180;180;180];
FlipPhaseComposite = [120;240;120];
