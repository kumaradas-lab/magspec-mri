...
%
% This is the composite pulse described in reference [11] of the chapter
...
%   A. J. Shaka and R. Freeman, J. Magn. Reson., 1983, 55, 487.
% From Table 2 (Variable Rotation Composite 180 DEG pulses):
%   rel. B1 bandwidth: {0.72, 1.28}   (1 is nominal)
%   rel. B0 bandwidth: {-0.45, 0.50}  (0 is nominal)
%
%
% INPUT:
%
