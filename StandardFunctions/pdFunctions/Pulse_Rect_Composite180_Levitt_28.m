function [pulseData] = Pulse_Rect_Composite180_Levitt_28(HW, Center, Pulse, varargin)
%% Create a composite 180 degree RF pulse as described by Levitt et al. [28]
%
%   pulseData = Pulse_Rect_Composite180_Levitt_28(HW, Center, Pulse)
% or:
%   pulseData = Pulse_Rect_Composite180_Levitt_28(HW, Center, Bandwidth, FlipAngle, MaxNumberOfSegments, MaxLength, Frequency, Phase)
% additionally:
%   excitationAngleFactor = Pulse_Rect_Composite180_Levitt_28(HW, 'Amp')
%   bandwidthFactor = Pulse_Rect_Composite180_Levitt_28(HW, 'Time')
%
% This is the composite pulse described in reference [28] of the chapter
...
%   A. J. Shaka, Chem. Phys. Lett., 1985, 120, 201.
% From Table 2 (Variable Rotation Composite 180 DEG pulses):
%   rel. B1 bandwidth: {0.94, 1.06}   (1 is nominal)
%   rel. B0 bandwidth: {-1.50, 1.50}  (0 is nominal)
%
%
% INPUT:
%
...
%% composite settings
FlipAngleComposite = [158; 171.2; 342.8; 145.5; 81.2; 85.3];
FlipPhaseComposite = [180;     0;   180;     0;  180;    0];
