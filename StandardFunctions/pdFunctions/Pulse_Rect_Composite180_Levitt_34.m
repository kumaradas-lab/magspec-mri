function [pulseData] = Pulse_Rect_Composite180_Levitt_34(HW, Center, Pulse, varargin)
%% Create a composite 180 degree RF pulse as described in Levitt et al. [34]
%
...
%   R. Tycko, A. Pines, and J. Guckenheimer, J. Chem. Phys., 1985, 83, 2775.
% From Table 2 (Variable Rotation Composite 180 DEG pulses):
%   rel. B1 bandwidth: {0.38, 1.33}   (1 is nominal)
%   rel. B0 bandwidth: {-0.76, 0.95}  (0 is nominal)
%
%
% INPUT:
%
...
%% composite settings
% FlipAngleComposite = [[180;180;180;180;180]    ; [180;180;180;180;180]    ; [180;180;180;180;180]    ; [180;180;180;180;180]    ; [180;180;180;180;180]    ];
% FlipPhaseComposite = [[  0;  0;120; 60;120]+  0; [  0;  0;120; 60;120]+  0; [  0;  0;120; 60;120]+120; [  0;  0;120; 60;120]+ 60; [  0;  0;120; 60;120]+120];
FlipAngleComposite = [[180+180;180;180;180]    ; [180+180;180;180;180]    ; [180+180;180;180;180]    ; [180+180;180;180;180]    ; [180+180;180;180;180]    ];
FlipPhaseComposite = [[  0+  0;120; 60;120]+  0; [  0+  0;120; 60;120]+  0; [  0+  0;120; 60;120]+120; [  0+  0;120; 60;120]+ 60; [  0+  0;120; 60;120]+120];
