function [pulseData] = Pulse_Rect_Composite90_Levitt_18(HW, Center, Pulse, varargin)
%% Create a composite 90 degree RF pulse as described in Levitt et al. [18]
%
%   pulseData = Pulse_Rect_Composite90_Levitt_18(HW, Center, Pulse)
% or:
%   pulseData = Pulse_Rect_Composite90_Levitt_18(HW, Center, Bandwidth, FlipAngle, MaxNumberOfSegments, MaxLength, Frequency, Phase)
% additionally:
%   excitationAngleFactor = Pulse_Rect_Composite90_Levitt_18(HW, 'Amp')
%   bandwidthFactor = Pulse_Rect_Composite90_Levitt_18(HW, 'Time')
%
% This is the composite pulse described in reference [18] of the chapter
...
%   R. Freeman, S. P. Kempsell, and M. H. Levitt, J. Magn. Reson., 1980, 38, 453.
% From Table 1 (Variable Rotation Composite 90 DEG pulses):
%   rel. B1 bandwidth: {0.73, 1.27}   (1 is nominal)
%   rel. B0 bandwidth: {-0.92, 0.92}  (0 is nominal)
%
%
% INPUT:
%
...
%% composite settings
FlipAngleComposite = [90; 90];
FlipPhaseComposite = [ 0; 90];
