function [pulseData] = Pulse_Rect_Composite180_Levitt_29(HW, Center, Pulse, varargin)
%% Create a composite 180 degree RF pulse as described by Levitt et al. [29]
%
%   pulseData = Pulse_Rect_Composite180_Levitt_29(HW, Center, Pulse)
% or:
%   pulseData = Pulse_Rect_Composite180_Levitt_29(HW, Center, Bandwidth, FlipAngle, MaxNumberOfSegments, MaxLength, Frequency, Phase)
% additionally:
%   excitationAngleFactor = Pulse_Rect_Composite180_Levitt_29(HW, 'Amp')
%   bandwidthFactor = Pulse_Rect_Composite180_Levitt_29(HW, 'Time')
%
% This is the composite pulse described in reference [29] of the chapter
...
%% composite settings
FlipAngleComposite = [90; 225;  315];
FlipPhaseComposite = [ 0; 180;   0];
