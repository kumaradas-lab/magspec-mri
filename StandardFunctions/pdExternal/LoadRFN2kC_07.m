...
% NOTE: This file describes the part of the Amp N2k Compact SN 07 that is
%       controlled by TX channels of the console. The parts of the amplifier
%       description that corresponds to the gradient channels is in
%       LoadGradAmp_N2kC_SN_07.m.


%% rf audio amplifier AmpN2k Compact SN 007
HW.TX(iDevice).ExtRFSN = 7;
HW.TX(iDevice).ExtRFType = 'RFN2kC';  % string with type identifier
...
AUXDAC2_Amp = 0;%round(-1.65e-3/3e-3*(2^10-1));  % AmpN2k SN007 - 28-04-2025 after 60 min pre-heat
