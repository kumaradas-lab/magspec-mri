%% calibration properties and settings for the probe COMPASS #4
...
HW.MPI.ACFrequency_max = 30000;  % maximum frequency in Hz
HW.MPI.DC_max = 20e-3;  % maximum DC amplitude in T
HW.MPI.AC_max = 20e-3;  % maximum AC amplitude in T
HW.MPI.DutyCycle_max = 0.5;
...
HW.TX(iDevice).LoadRin(2) = 3.43/(7.85/2);  % resistance of COMPASS TX coil in Ohm
...
HW.TX(iDevice).Inductance(2) = 58e-6;  % inductance of COMPASS TX coil in Henry
...
TXACcal=[1,   1000, 7.83/2];
TXACcal=[2,   2000, 7.78/2];
TXACcal=[3,   5000, 7.77/2];
TXACcal=[4,   7500, 7.83/2];
TXACcal=[5,  10000, 7.89/2];
TXACcal=[6,  15000, 7.94/2];
TXACcal=[7,  20000, 7.97/2];
TXACcal=[8,  25000, 7.95/2];
TXACcal=[9,  30000, 7.87/2];
