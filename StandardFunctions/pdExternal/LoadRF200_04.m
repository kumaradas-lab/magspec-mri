...
HW.TX(iDevice).Uout2PaUout(2) = 10^((-15.0+53.0-3.0)/20);  % 53.0 dB amplification @ 13.0 MHz, 1.0 V with switch

HW.TX(iDevice).Max.PaUout(2) = 100;  % maximum peak output voltage in V
