...
HW.Grad(iDevice).ExtGradSN = 50;                              % serial number
...
HW.Grad(iDevice).PaOffsetI(1:3) = [-0.0008186942, 0.003717635, 0.002332207];  % offset current in A  30-Aug-2022 15:35:10

HW.Grad(iDevice).PaUin2PaIout(1:3) = ([0.332931, 0.3368592, 0.3361983] - HW.Grad(iDevice).PaOffsetI(1:3)) ./ 1;  % amplification in A/V  30-Aug-2022 15:35:10
...
% HW.Grad(iDevice).SystemTimeDelay(1:3) = [35e-6, 50e-6, 45e-6];  % time delay of gradient amplifier in s
...
% HW.Grad(iDevice).PaOffsetI(1:4) = [-0.0008186942, 0.003717635, 0.002332207, 0.0007337572];  % offset current in A  30-Aug-2022 15:35:10
% 
% HW.Grad(iDevice).PaUin2PaIout(1:4) = ([0.332931, 0.3368592, 0.3361983, 0.3346945] - HW.Grad(iDevice).PaOffsetI) ./ 1;  % amplification in A/V  30-Aug-2022 15:35:10
% 
