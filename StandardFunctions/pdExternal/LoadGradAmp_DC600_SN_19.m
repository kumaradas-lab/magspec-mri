...
HW.Grad(iDevice).ExtGradSN = 19;                              % serial number
...
HW.Grad(iDevice).PaOffsetI(1:4) = [-0.004124942, -0.002204735, 0.0006412072, 0.0004767803];  % offset current in A, 25-Oct-2018 16:24:38

HW.Grad(iDevice).PaUin2PaIout(1:4) = ([0.3292542, 0.3304975, 0.3332017, 0.3328445] - HW.Grad(iDevice).PaOffsetI(1:4)) ./ 1;  % amplification in A/V, 25-Oct-2018 16:24:38
