...
HW.Grad(iDevice).ExtGradSN = 15;                              % serial number
...
HW.Grad(iDevice).PaOffsetI(1:4) = [-0.004175047, 0.0005158347, -3.5329e-05, 0.003184625];  % offset current in A, 27-Oct-2017 17:25:09

HW.Grad(iDevice).PaUin2PaIout(1:4) = ([0.3289832, 0.3328522, 0.3326437, 0.3360698] - HW.Grad(iDevice).PaOffsetI(1:4)) ./ 1;  % amplification in A/V, 27-Oct-2017 17:26:35
...
HW.Grad(iDevice).SystemTimeDelay(1:3) = [4.7776e-05, 5.6128e-05, 5.644e-05];  % time delay of gradient amplifier in s
