...
HW.Grad(iDevice).ExtGradSN = 37;                              % serial number
...
HW.Grad(iDevice).PaOffsetI(1:4) = [0.0005813423, -0.001666227, 0.00481892, 0.0008538293];  % offset current in A, 16-Mar-2021 13:49:51

HW.Grad(iDevice).PaUin2PaIout(1:4) = ([0.3331508 ,0.330962, 0.3367852, 0.3326213] - HW.Grad(iDevice).PaOffsetI(1:4)) ./ 1;  % amplification in A/V, 16-Mar-2021 13:49:51
...
HW.Grad(iDevice).SystemTimeDelay(1:3) = [2.1506e-05, 2.726e-05, 2.6904e-05];  % time delay of gradient amplifier in s
