...
HW.Grad(iDevice).ExtGradSN = 26;                              % serial number
...
HW.Grad(iDevice).PaOffsetI(1:4) = [0.001548337, 0.001442667, 0.0008353942, -0.00323112];  % offset current in A, 13-May-2019 13:12:48

HW.Grad(iDevice).PaUin2PaIout(1:4) = ([0.333947, 0.3341918, 0.3335547, 0.3284165] - HW.Grad(iDevice).PaOffsetI(1:4))./1;  % amplification in A/V, 13-May-2019 13:12:48
