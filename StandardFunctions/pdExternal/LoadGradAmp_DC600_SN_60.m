...
HW.Grad(iDevice).ExtGradSN = 60;                              % serial number
...
HW.Grad(iDevice).PaOffsetI(1:4) = [0.003961307, 0.004704675, 0.001335105, -0.0002153023];  % offset current in A  01-Feb-2024 09:03:07

HW.Grad(iDevice).PaUin2PaIout(1:4) = ([0.3377805, 0.3385597, 0.3349033, 0.3326923] - HW.Grad(iDevice).PaOffsetI) ./ 1;  % amplification in A/V  01-Feb-2024 09:03:07
