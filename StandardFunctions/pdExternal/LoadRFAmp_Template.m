...
HW.TX.ExtRFSN = 9999;
HW.TX.ExtRFType = 'myRFAmpType';  % string with type identifier
...
HW.TX.Def.PaUout(2) = 50;  % default PaUout(2)=50 V => 25 W
...
HW.TX.BlankOffset = 1200e-9;  % Unblank rf amplifier before TX pulse in s
HW.TX.BlankPostset = 400e-9;  % Blank rf amplifier after TX pulse in s
