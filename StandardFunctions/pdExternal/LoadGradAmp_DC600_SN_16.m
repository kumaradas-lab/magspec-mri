...
HW.Grad(iDevice).ExtGradSN = 16;                              % serial number
...
HW.Grad(iDevice).PaOffsetI(1:4) = [0.000820025, -0.00244663, -0.000939453, 0.002883367];  % offset current in A, 15-May-2018 17:25:35

HW.Grad(iDevice).PaUin2PaIout(1:4) = ([0.3341075, 0.330605, 0.332273, 0.3358417] - HW.Grad(iDevice).PaOffsetI(1:4)) ./ 1;  % amplification in A/V, 15-May-2018 17:25:35
