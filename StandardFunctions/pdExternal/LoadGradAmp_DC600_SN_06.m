...
HW.Grad(iDevice).ExtGradSN = 6;                               % serial number
...
HW.Grad(iDevice).PaOffsetI(1:4) = [-0.00090741, -0.00090608, 0.01625, -0.0030908];  % offset current in A

HW.Grad(iDevice).PaUin2PaIout(1:4) = ([0.33325, 0.3337, 0.34873, 0.33248] - HW.Grad(iDevice).PaOffsetI) ./ 1;  % amplification in A/V

HW.Grad(iDevice).PaPmaxInt(1:4) = [103, 103, 103, 103];       % maximum internal power dissipation in W
