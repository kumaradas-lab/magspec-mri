%% Settings for low power broadband LNA #75
% modified to be used in conjuction with a L/4-switch at 22.4MHz
% replaces permanently inactive LNA #68 since 09.2025

if ~exist('iDevice', 'var'), iDevice = 1; end

HW.RX(iDevice).LnaSN = 75;
...
HW.RX(iDevice).LNAGain = 10^(((-49.3381)-(-71.075))/20);  % 21.7369 dB gain @ 22400432.6884 MHz F=1.8317 dB (-71.075 dBm cal)
