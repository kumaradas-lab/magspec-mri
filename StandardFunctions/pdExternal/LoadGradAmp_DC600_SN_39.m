...
HW.Grad(iDevice).ExtGradSN = 39;                              % serial number
...
HW.Grad(iDevice).PaOffsetI(1:4) = [0.002433855, -9.280638e-05, 0.003974642, 0.003972742];  % offset current in A

HW.Grad(iDevice).PaUin2PaIout(1:4) = ([0.3357538, 0.333246, 0.3370163, 0.337338] - HW.Grad(iDevice).PaOffsetI(1:4)) ./ 1;  % amplification in A/V
