...
HW.Grad(iDevice).ExtGradSN = 20;                              % serial number
...
HW.Grad(iDevice).PaOffsetI(1:4) = [0.003543242, 0.0008997097, 0.001845882, 0.003115182];  % offset current in A, 25-Oct-2018 11:13:15

HW.Grad(iDevice).PaUin2PaIout(1:4) = ([0.3362695, 0.3331065, 0.3347147, 0.3356388] - HW.Grad(iDevice).PaOffsetI(1:4)) ./ 1;  % amplification in A/V, 25-Oct-2018 11:13:15
