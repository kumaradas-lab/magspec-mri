%% Settings for LNA #40 21.1 MHz

if ~exist('iDevice', 'var'), iDevice = 1; end

HW.RX(iDevice).LnaSN = 40;
...
HW.RX(iDevice).LNAGain = 10^(((-51.9903)-(-73.8546))/20);  % 21.8643 dB gain @ 21100386.0379 MHz F=1.3979 dB (-73.8546 dBm cal)
