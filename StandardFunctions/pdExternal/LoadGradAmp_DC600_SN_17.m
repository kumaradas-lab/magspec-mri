...
HW.Grad(iDevice).ExtGradSN = 17;                              % serial number
...
HW.Grad(iDevice).PaOffsetI(1:4) = [-0.002585665, 0.001740887, -0.000628206, 0.002483215];   % offset current in A, 17-May-2018 10:48:37
 
HW.Grad(iDevice).PaUin2PaIout(1:4) = ([0.330494, 0.3329757, 0.3323808, 0.3348418] - HW.Grad(iDevice).PaOffsetI(1:4)) ./ 1;  % amplification in A/V, 17-May-2018 10:48:38
