...
HW.Grad(iDevice).ExtGradSN = 59;                              % serial number
...
HW.Grad(iDevice).PaOffsetI(1:4) = [0.002202467, -0.00212201, -0.0009952475, 0.005867983];  % offset current in A  26-Jan-2024 10:06:40

HW.Grad(iDevice).PaUin2PaIout(1:4) = ([0.3354018, 0.3312258, 0.3319057, 0.3386088] - HW.Grad(iDevice).PaOffsetI) ./ 1;  % amplification in A/V  26-Jan-2024 10:06:40
...
HW.Grad(iDevice).MaxAmpSlice = 0.02;                           % maximum gradient amplitude for slice selection in T/m
