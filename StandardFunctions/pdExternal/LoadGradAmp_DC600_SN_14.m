...
HW.Grad(iDevice).PaOffsetI(1:4) = [0.003034678, -0.0006314275, 0.001174667, 0.001662802];  % offset current in A

HW.Grad(iDevice).PaUin2PaIout(1:4) = ([0.3358092, 0.332277, 0.3327882, 0.333347] - HW.Grad(iDevice).PaOffsetI(1:4)) ./ 1;  % amplification in A/V
