...
HW.Grad(iDevice).ExtGradSN = 52;                              % serial number
...
HW.Grad(iDevice).PaOffsetI(1:4) = [0.002699145, -0.003839095, 0.0005194097, -0.00168102];  % offset current in A  30-Aug-2022 08:00:03

HW.Grad(iDevice).PaUin2PaIout(1:4) = ([0.3351067, 0.3295323, 0.3342653, 0.3319152] - HW.Grad(iDevice).PaOffsetI) ./ 1;  % amplification in A/V  30-Aug-2022 08:00:03
...
HW.Grad(iDevice).SystemTimeDelay(1:3) = [38.096, 49.084, 47.702]*1e-6;  % time delay of gradient amplifier in s
