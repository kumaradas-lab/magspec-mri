...
%       LoadGradAmp_N2kC_SN_08.m.


%% rf audio amplifier AmpN2k SN 008 compact !!115V!!
HW.TX(iDevice).ExtRFSN = 8;
...
AUXDAC2_Amp = round(-0.25e-3/3e-3*(2^10-1));  % AmpN2k SN008 - 25-06-2024 after 60 min pre-heat
