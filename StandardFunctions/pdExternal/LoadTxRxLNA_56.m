%% Settings for low power broadband LNA #56
% built Sep 2023

if ~exist('iDevice', 'var'), iDevice = 1; end

HW.RX(iDevice).LnaSN = 56;
...
HW.RX(iDevice).LNAGain = 10^(((-49.6088)-(-71.14))/20);  % 21.5312 dB gain @ 24300454.316 MHz F=1.1905 dB (-71.14 dBm cal)
