%% Settings for rf amplifier RF-100 with SN 22
...
HW.TX.Def.PaUout(2) = 20;        % default PaUout(2)=50 V => 25 W
...
HW.TX2RXdeadTime = 40e-6;        % Receiver deadtime after TX pulse in s e.g. ringing of Coil ~40 µs
