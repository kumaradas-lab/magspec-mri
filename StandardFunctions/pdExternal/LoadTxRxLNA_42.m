%% Settings for LNA #42 13.1 MHz

if ~exist('iDevice', 'var'), iDevice = 1; end

HW.RX(iDevice).LnaSN = 42;
...
HW.RX(iDevice).LNAGain = 10^(((-50.6296)-(-73.1742))/20);  % 22.5446 dB gain @ 13100241.2689 MHz F=2.1243 dB (-73.1742 dBm cal)
