...
HW.Grad(iDevice).ExtGradSN = 23;                              % serial number
...
HW.Grad(iDevice).PaOffsetI(1:4) = [-0.001519135, -0.00123852, -0.00452556, 0.0007421785];  % offset current in A, 12-Nov-2018 13:18:49

HW.Grad(iDevice).PaUin2PaIout(1:4) = ([0.3319863, 0.331572, 0.3288497, 0.3324137] - HW.Grad(iDevice).PaOffsetI(1:4)) ./ 1;  % amplification in A/V, 12-Nov-2018 13:18:49
