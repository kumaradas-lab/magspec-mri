...
HW.Grad(iDevice).ExtGradSN = 54;                              % serial number
...
HW.Grad(iDevice).PaOffsetI(1:4) = [-0.002348447, -0.0002476353, 0.001519112, 0.003723238];  % offset current in A  30-Aug-2022 09:11:39

HW.Grad(iDevice).PaUin2PaIout(1:4) = ([0.3317823, 0.3332008, 0.3347875, 0.3369217] - HW.Grad(iDevice).PaOffsetI) ./ 1;  % amplification in A/V  30-Aug-2022 09:11:39
...
HW.Grad(iDevice).SystemTimeDelay(1:3) = [36.228, 49.186, 50.784]*1e-6;  % time delay of gradient amplifier in s
