%% Settings fow power broadband LNA #71
% version Gen2e 07.2025

if ~exist('iDevice', 'var'), iDevice = 1; end

HW.RX(iDevice).LnaSN = 71;
...
HW.RX(iDevice).LNAGain = 10^(((-53.1458)-(-74.97))/20);  % 21.8242 dB gain @ 21500411.0524 MHz F=1.1346 dB (-74.97 dBm cal)
