%% calibration properties and settings for the probe COMPASS #1
...
HW.TX(iDevice).LoadRin(2) = 3.65/(8.14/2);  % resistance of COMPASS TX coil in Ohm
...
HW.TX(iDevice).Inductance(2) = 70e-6;  % inductance of COMPASS TX coil in Henry
...
if ~isCalibratedCH5
  ...
  I_peak_ACmeas = 8.1/2;  % [A]
  I_peak_DCmeas = 8.1/2;  % [A]
...
TXACcal=[1,   1000, 7.89/2];
TXACcal=[2,   2000, 7.86/2];
TXACcal=[3,   5000, 7.86/2];
TXACcal=[4,   7500, 7.91/2];
TXACcal=[5,  10000, 7.94/2];
TXACcal=[6,  15000, 7.97/2];
TXACcal=[7,  20000, 7.95/2];
TXACcal=[8,  25000, 7.88/2];
TXACcal=[9,  30000, 7.75/2];
TXACcal=[10, 40000, 7.46/2];
