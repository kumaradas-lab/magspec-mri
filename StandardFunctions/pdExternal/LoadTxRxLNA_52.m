%% Settings for LNA #52 24.3 MHz

% Low power broadband LNA built Sep 2023

if ~exist('iDevice', 'var'), iDevice = 1; end

HW.RX(iDevice).LnaSN = 52;
...
HW.RX(iDevice).LNAGain = 10^(((-51.6852)-(-71.154))/20);  % 19.4688 dB gain @ 24300454.5273 MHz F=1.0898 dB (-71.154 dBm cal)
