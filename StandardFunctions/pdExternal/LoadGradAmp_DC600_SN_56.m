...
HW.Grad(iDevice).ExtGradSN = 56;                              % serial number
...
HW.Grad(iDevice).PaOffsetI(1:4) = [0, -0.006573638, -0.003756397, 0.001040648];  % offset current in A  29-Jan-2024 08:17:01

HW.Grad(iDevice).PaUin2PaIout(1:4) = ([0.33, 0.3271315, 0.3301968, 0.3348178] - HW.Grad(iDevice).PaOffsetI) ./ 1;  % amplification in A/V  29-Jan-2024 08:17:01
...
HW.Grad(iDevice).SystemTimeDelay(1:3) = [45e-6, 45e-6, 45e-6];  % time delay of gradient amplifier in s
