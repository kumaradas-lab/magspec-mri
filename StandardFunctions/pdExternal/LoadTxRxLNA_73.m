%% Settings for low power broadband LNA #73
% version Gen2e 07.2025

if ~exist('iDevice', 'var'), iDevice = 1; end

HW.RX(iDevice).LnaSN = 73;
...
HW.RX(iDevice).LNAGain = 10^(((-53.2318)-(-74.97))/20);  % 21.7382 dB gain @ 21500410.9637 MHz F=1.2982 dB (-74.97 dBm cal)
