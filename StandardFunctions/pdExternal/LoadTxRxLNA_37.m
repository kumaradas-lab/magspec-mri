%% Settings for LNA #37 24.15 MHz

if ~exist('iDevice', 'var'), iDevice = 1; end

HW.RX(iDevice).LnaSN = 37;
...
HW.RX(iDevice).LNAGain = 10^(((-44.0412)-(-67.6))/20);  % 23.5588 dB gain @ 24150350.4346 MHz F=0.72833 dB (-67.6 dBm cal)
