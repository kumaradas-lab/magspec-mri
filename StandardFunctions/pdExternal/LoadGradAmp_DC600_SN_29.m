...
HW.Grad(iDevice).ExtGradSN = 29;                              % serial number
...
HW.Grad(iDevice).PaOffsetI = [0.001754808, -9.21944e-05, -0.003196862, -0.0006354438];  % offset current in A, 25-Mar-2020 14:40:10

HW.Grad(iDevice).PaUin2PaIout = ([0.3324188, 0.3325537, 0.3284918, 0.3319077] - HW.Grad(iDevice).PaOffsetI)./1;  % amplification in A/V, 25-Mar-2020 14:40:10
