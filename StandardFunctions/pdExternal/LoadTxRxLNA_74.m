%% Settings for low power broadband LNA #74
% version Gen2e 07.2025

if ~exist('iDevice', 'var'), iDevice = 1; end

HW.RX(iDevice).LnaSN = 74;
...
HW.RX(iDevice).LNAGain = 10^(((-53.1847)-(-74.97))/20);  % 21.7853 dB gain @ 21500410.8 MHz F=1.1467 dB (-74.97 dBm cal)
