%% Settings for LNA #53 24.3 MHz

% Low power broadband LNA built Aug 2023

if ~exist('iDevice', 'var'), iDevice = 1; end

HW.RX(iDevice).LnaSN = 53;
...
HW.RX(iDevice).LNAGain = 10^(((-39.2655)-(-60.7855))/20);  % 21.52 dB gain @ 24300442.6037 MHz F=1.1715 dB (-60.7855 dBm cal)
% HW.RX(iDevice).LNAGain = 10^(((-49.3619)-(-70.7971))/20);  % 21.4352 dB gain @ 21490400.4792 MHz F=1.3386 dB (-70.7971 dBm cal)
