...
HW.Grad(iDevice).ExtGradSN = 66;                              % serial number
...
HW.Grad(iDevice).PaOffsetI(1:4) = [-0.00189362, -0.001108415, -0.0008638818, 0.002208862];  % offset current in A  07-Apr-2025 15:34:16

HW.Grad(iDevice).PaUin2PaIout(1:4) = ([0.3319998, 0.3317497, 0.3326525, 0.3348422] - HW.Grad(iDevice).PaOffsetI) ./ 1;  % amplification in A/V  07-Apr-2025 15:34:16
