...
HW.Grad(iDevice).ExtGradSN = 47;                              % serial number
...
HW.Grad(iDevice).PaOffsetI(1:4) = [0.0005219865, 0.001619583, -0.0002660242, -7.021772e-05];  % offset current in A  15-Feb-2022 15:18:05

HW.Grad(iDevice).PaUin2PaIout(1:4) = ([0.0837882, 0.08488293, 0.08299362, 0.08316902] - HW.Grad(iDevice).PaOffsetI) ./ 1;  % amplification in A/V  15-Feb-2022 15:18:05
...
HW.Grad(iDevice).tEC = 100e-6;                                 % eddy current time in s
