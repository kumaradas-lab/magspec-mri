...
% Amplifier
HW.TX.Uout2PaUout(2) = 10^((-15.0+53.0-3.0)/20);  % 53.0 dB amplification @ 2.5 MHz, 1.0 V without switch
HW.TX.Uout2PaUout(2) = 10^((-15.0+53.0-3.0)/20);  % 53.0 dB amplification @ 2.5 MHz, 1.0 V with switch
