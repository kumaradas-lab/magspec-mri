...
%% rf audio amplifier AmpN2k SN 002
HW.TX(iDevice).ExtRFSN = 2;
HW.TX(iDevice).ExtRFType = 'RFN2k';  % string with type identifier
...
AUXDAC2_Amp = round(-0.25e-3/3e-3*(2^10-1));  % AmpN2k SN002 - 25-06-2024 after 60 min pre-heat
