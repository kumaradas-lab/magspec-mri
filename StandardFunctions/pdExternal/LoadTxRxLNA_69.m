%% Settings for low power broadband LNA #69
% modified to be used in conjuction with a separate broadband send and receive
% switch

if ~exist('iDevice', 'var'), iDevice = 1; end

HW.RX(iDevice).LnaSN = 69;
...
HW.RX(iDevice).LNAGain = 10^(((-59.8243)-(-80.23))/20);  % 20.4057 dB gain @ 18800339.3732 MHz F=1.721 dB (-80.23 dBm cal)
