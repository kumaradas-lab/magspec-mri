%% Settings for low power broadband LNA #58
% built Sep 2023

if ~exist('iDevice', 'var'), iDevice = 1; end

HW.RX(iDevice).LnaSN = 58;
...
HW.RX(iDevice).LNAGain = 10^(((-49.8537)-(-71.14))/20);  % 21.2863 dB gain @ 24300454.2309 MHz F=1.2003 dB (-71.14 dBm cal)
