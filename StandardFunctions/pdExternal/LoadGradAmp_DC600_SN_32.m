...
HW.Grad(iDevice).ExtGradSN = 32;                              % serial number
...
HW.Grad(iDevice).PaOffsetI(1:4) = [0.003912147, 0.001911173, 0.004236637, -0.0009828728];  % offset current in A, 15-Mar-2021 14:44:15

HW.Grad(iDevice).PaUin2PaIout(1:4) = ([0.3364752, 0.3342737, 0.336606, 0.3317402] - HW.Grad(iDevice).PaOffsetI(1:4)) ./ 1;  % amplification in A/V, 15-Mar-2021 14:44:15
...
HW.Grad(iDevice).SystemTimeDelay(1:3) = [2.2056e-05, 2.5624e-05, 2.6776e-05];  % time delay of gradient amplifier in s
