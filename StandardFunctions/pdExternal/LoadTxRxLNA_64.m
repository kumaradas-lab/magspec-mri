%% Settings for low power broadband LNA #64 with low frequency modification
% built Mar 2024

if ~exist('iDevice', 'var'), iDevice = 1; end

HW.RX(iDevice).LnaSN = 64;
...
HW.RX(iDevice).LNAGain = 10^(((-49.6514)-(-71.06))/20);  % 21.4086 dB gain @ 24500456.2148 MHz F=1.0607 dB (-71.06 dBm cal)
