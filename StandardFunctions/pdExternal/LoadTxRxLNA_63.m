%% Settings for low power broadband LNA #63 with low frequency modification
% built Mar 2024

if ~exist('iDevice', 'var'), iDevice = 1; end

HW.RX(iDevice).LnaSN = 63;
...
HW.RX(iDevice).LNAGain = 10^(((-49.6237)-(-71.06))/20);  % 21.4363 dB gain @ 24500455.4175 MHz F=1.1702 dB (-71.06 dBm cal)
