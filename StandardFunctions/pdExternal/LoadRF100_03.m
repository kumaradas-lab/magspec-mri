%% Settings for rf amplifier RF-100 with SN 3
...
% Amplifier
HW.TX.Uout2PaUout = [1, 10^(40/20)];  % 36 dB to 40 dB amplification
% HW.TX.Uout2PaUout = [1,10^(-1/20)];  % 36 dB to 40 dB amplification
HW.TX.Max.PaUout(2) = 250;  % maximum peak output voltage in V

HW.TX.Def.PaUout(2) = 30;  % default peak output voltage in V (might be reduced by other HW.TX.Def settings)
...
%% RX Settings
HW.RX.VGAGainDef = HW.RX.VGAGainMax/2; % default VGA gain
...
% HW.TX.BlankOffset = 200e-9;     % Unblank of RF-100 before TX pulse in s
% HW.TX.BlankPostset = 80e-9;     % Blank of RF-100 after TX pulse in s
% HW.TX.BlankOffsetAQ = 200e-9;   % Blank of receiver before TX pulse
% HW.TX.BlankPostsetAQ = 400e-9;  % Blank of receiver after TX pulse
