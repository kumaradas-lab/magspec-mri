...
HW.Grad(iDevice).ExtGradSN = 18;                              % serial number
...
HW.Grad(iDevice).PaOffsetI(1:4) = [0.002307707, -0.001242077, 0.003051957, -0.001274058];  % offset current in A, 17-May-2018 12:26:58

HW.Grad(iDevice).PaUin2PaIout(1:4) = ([0.3341128, 0.3316297, 0.3358662, 0.3317328] - HW.Grad(iDevice).PaOffsetI(1:4)) ./ 1;  % amplification in A/V, 17-May-2018 12:26:58
