...
HW.Grad(iDevice).ExtGradSN = 46;                              % serial number
...
HW.Grad(iDevice).PaOffsetI(1:4) = [-0.002102578, 0.002384427, 0.0004915875, -0.0005252512];  % offset current in A  15-Feb-2022 09:04:01

HW.Grad(iDevice).PaUin2PaIout(1:4) = ([0.1646297, 0.1691843, 0.1670518, 0.1661402] - HW.Grad(iDevice).PaOffsetI) ./ 1; % amplification in A/V  15-Feb-2022 09:04:01
