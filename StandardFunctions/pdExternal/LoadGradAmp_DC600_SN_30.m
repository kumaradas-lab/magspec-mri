...
HW.Grad(iDevice).ExtGradSN = 30;                              % serial number
...
HW.Grad(iDevice).PaOffsetI(1:4) = [-0.000342823, 0.00331074, -0.0002937403, -0.002939028];  % offset current in A, 14-May-2020 14:44:27

HW.Grad(iDevice).PaUin2PaIout(1:4) = ([0.3317603, 0.3349532, 0.3327892, 0.329336] - HW.Grad(iDevice).PaOffsetI(1:4)) ./ 1;  % amplification in A/V, 14-May-2020 14:44:27
