...
HW.Grad(iDevice).ExtGradSN = 12;                              % serial number
...
HW.Grad(iDevice).PaOffsetI(1:4) = [-0.000617728, -0.00237676, 0.001106902, -0.001898635];  % offset current in A, 08-Nov-2016 15:58:22

HW.Grad(iDevice).PaUin2PaIout(1:4) = ([0.3340265, 0.3320015, 0.3363447, 0.3317287] - HW.Grad(iDevice).PaOffsetI(1:4)) ./ 1;  % amplification in A/V, 08-Nov-2016 16:00:14
