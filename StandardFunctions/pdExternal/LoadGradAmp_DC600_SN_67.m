...
HW.Grad(iDevice).ExtGradSN = 67;                              % serial number
...
HW.Grad(iDevice).PaOffsetI(1:4) = [0.0008788622, -0.004949393, 0.001083513, -0.00269967];  % offset current in A  07-Apr-2025 08:35:45

HW.Grad(iDevice).PaUin2PaIout(1:4) = ([0.3337288, 0.3279873, 0.3347785, 0.3303147] - HW.Grad(iDevice).PaOffsetI) ./ 1;  % amplification in A/V  07-Apr-2025 08:35:45
