%% Settings for LNA #27 24.14 MHz

if ~exist('iDevice', 'var'), iDevice = 1; end

HW.RX(iDevice).LnaSN = 27;
...
HW.RX(iDevice).LNAGain = 10^(((-33.8113)-(-60))/20);  % 26.1887 dB gain @ 24140361.3451 MHz F=0.97677 dB (-60 dBm cal) and HW.RX(iDevice).VGAGainMax/6
