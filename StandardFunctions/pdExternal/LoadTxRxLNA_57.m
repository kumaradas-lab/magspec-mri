%% Settings for low power broadband LNA #57
% built Sep 2023

if ~exist('iDevice', 'var'), iDevice = 1; end

HW.RX(iDevice).LnaSN = 57;
...
HW.RX(iDevice).LNAGain = 10^(((-49.7651)-(-71.14))/20);  % 21.3749 dB gain @ 24300454.2373 MHz F=1.1418 dB (-71.14 dBm cal)
