%% Settings for low power broadband LNA #62 with low frequency modification
% built Mar 2024
% further modified with high pass filter Jan 2025

if ~exist('iDevice', 'var'), iDevice = 1; end

HW.RX(iDevice).LnaSN = 62;
...
%HW.RX(iDevice).LNAGain = 10^(((-49.5811)-(-71.03))/20);  % 21.4489 dB gain @ 24500448.7312 MHz F=1.1058 dB (-71.03 dBm cal) without low pass
HW.RX(iDevice).LNAGain = 10^(((-59.3252)-(-80.73))/20);  % 21.4048 dB gain @ 24500445.8965 MHz F=1.1675 dB (-80.73 dBm cal)
HW.RX(iDevice).LNAGain = 10^(((-58.6685)-(-80.3))/20);  % 21.6315 dB gain @ 18800356.3266 MHz F=1.608 dB (-80.3 dBm cal)
