%% Settings for low power broadband LNA #55
% built Sep 2023

if ~exist('iDevice', 'var'), iDevice = 1; end

HW.RX(iDevice).LnaSN = 55;
...
HW.RX(iDevice).LNAGain = 10^(((-49.7245)-(-71.14))/20);  % 21.4155 dB gain @ 24300454.2576 MHz F=1.0707 dB (-71.14 dBm cal)
