%% Settings for LNA #44 24.4 MHz

if ~exist('iDevice', 'var'), iDevice = 1; end

HW.RX(iDevice).LnaSN = 44;
...
HW.RX(iDevice).LNAGain = 10^(((-48.9122)-(-71.358))/20);  % 22.4458 dB gain @ 24400389.399 MHz F=1.2669 dB (-71.358 dBm cal)
