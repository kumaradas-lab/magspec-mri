...
HW.Grad(iDevice).ExtGradSN = 33;                              % serial number
...
HW.Grad(iDevice).PaOffsetI(1:4) = [-0.002960653, -0.00355699, -0.004932472, -0.0004918795];  % offset current in A, 15-Mar-2021 15:13:19

HW.Grad(iDevice).PaUin2PaIout(1:4) = ([0.3276223, 0.328037, 0.3274313, 0.3315683] - HW.Grad(iDevice).PaOffsetI(1:4)) ./ 1;  % amplification in A/V, 15-Mar-2021 15:13:19
...
HW.Grad(iDevice).SystemTimeDelay(1:3) = [2.276e-05, 2.54192e-05, 2.63672e-05];  % time delay of gradient amplifier in s
