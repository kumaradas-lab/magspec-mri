...
% connected to high Q resonant coil with 10mm
...
% HW.RX.LNAGain=10^(19.6/20); % Gain of preamp  at 4.7 MHz MAR-6SM+ NF=2.3 dB
HW.RX.LNAGain=10^(19.25/20); % Gain of preamp  at 9 MHz MAR-6SM+ NF=2.5 dB
...
HW.TX.BlankPostsetAQ=8e-6;%HW.TX.BlankPostset+3000e-9;     % Blank of receiver after TX pulse
