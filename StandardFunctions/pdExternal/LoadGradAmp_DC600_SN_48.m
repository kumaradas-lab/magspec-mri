...
HW.Grad(iDevice).ExtGradSN = 48;                              % serial number
...
HW.Grad(iDevice).PaOffsetI(1:4) = [-0.002242097, -9.510473e-05, -0.00549265, -0.003691205];  % offset current in A  29-Aug-2022 12:33:05

HW.Grad(iDevice).PaUin2PaIout(1:4) = ([0.3315677, 0.3341318, 0.32862, 0.329413] - HW.Grad(iDevice).PaOffsetI) ./ 1;  % amplification in A/V  29-Aug-2022 12:33:05
...
HW.Grad(iDevice).SystemTimeDelay(1:3) = [35.636, 48.732, 47.598]*1e-6;  % time delay of gradient amplifier in s
