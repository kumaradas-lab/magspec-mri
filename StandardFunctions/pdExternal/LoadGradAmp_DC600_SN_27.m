...
HW.Grad(iDevice).ExtGradSN = 27;                              % serial number
...
HW.Grad(iDevice).PaOffsetI(1:4) = [0.001283885, -0.002732197, -0.0002136737, 0.001214818];  % offset current in A, 10-May-2019 07:48:43

HW.Grad(iDevice).PaUin2PaIout(1:4) = ([0.3331777, 0.3298805, 0.3321812, 0.3340018] - HW.Grad(iDevice).PaOffsetI(1:4)) ./ 1;  % amplification in A/V, 10-May-2019 07:48:43
...
HW.Grad(iDevice).SystemTimeDelay(1:3) = [2.3008e-05, 3.012e-05, 3.1608e-05];  % time delay of gradient amplifier in s
