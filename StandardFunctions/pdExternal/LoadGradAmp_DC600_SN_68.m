...
HW.Grad(iDevice).ExtGradSN = 68;                              % serial number
...
HW.Grad(iDevice).PaOffsetI(1:4) = [0.002921642, -0.0008929115, -0.003189643, -0.0001812068];  % offset current in A  07-Apr-2025 09:29:16

HW.Grad(iDevice).PaUin2PaIout(1:4) = ([0.3358178, 0.3329995, 0.328684, 0.3327962] - HW.Grad(iDevice).PaOffsetI) ./ 1;  % amplification in A/V  07-Apr-2025 09:29:16
