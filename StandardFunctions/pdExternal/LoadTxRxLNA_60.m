%% Settings for low power broadband LNA #60 with low frequency modification
% built Mar 2024

if ~exist('iDevice', 'var'), iDevice = 1; end

HW.RX(iDevice).LnaSN = 60;
...
HW.RX(iDevice).LNAGain = 10^(((-49.4025)-(-71.03))/20);  % 21.6275 dB gain @ 24500436.9405 MHz F=1.1117 dB (-71.03 dBm cal)
