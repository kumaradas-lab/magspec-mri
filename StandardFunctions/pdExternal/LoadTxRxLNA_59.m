%% Settings for low power broadband LNA #59 with low frequency modification
% built Jan 2024

if ~exist('iDevice', 'var'), iDevice = 1; end

HW.RX(iDevice).LnaSN = 59;
...
HW.RX(iDevice).LNAGain = 10^(((-46.9595)-(-69.39))/20);  % 22.4305 dB gain @ 2130039.6879 MHz F=4.6157 dB (-69.39 dBm cal)
