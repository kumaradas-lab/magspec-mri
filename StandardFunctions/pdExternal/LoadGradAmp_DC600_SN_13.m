...
HW.Grad(iDevice).ExtGradSN = 13;                              % serial number
...
HW.Grad(iDevice).PaOffsetI(1:4) = [-0.0006787158, 0.004485248, 0.004561805, -0.0007518598];  % offset current in A, 11-Nov-2016 16:49:21

HW.Grad(iDevice).PaUin2PaIout(1:4) = ([0.3326395, 0.3390927, 0.3395482, 0.333706] - HW.Grad(iDevice).PaOffsetI(1:4)) ./ 1;  % amplification in A/V, 11-Nov-2016 16:51:07
