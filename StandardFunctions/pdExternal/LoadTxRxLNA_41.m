%% Settings for LNA #41 21.4 MHz

if ~exist('iDevice', 'var'), iDevice = 1; end

HW.RX(iDevice).LnaSN = 41;
...
HW.RX(iDevice).LNAGain = 10^(((-52.1254)-(-73.8546))/20);  % 21.7292 dB gain @ 21490381.8077 MHz F=1.2914 dB (-73.8546 dBm cal)
