...
HW.Grad(iDevice).ExtGradSN = 64;                              % serial number
...
HW.Grad(iDevice).PaOffsetI(1:4) = [-0.004073787, 0.006915268, 0.001427822, 0.002136592];  % offset current in A  25-Mar-2025 09:51:39

HW.Grad(iDevice).PaUin2PaIout(1:4) = ([0.3290262, 0.3398652, 0.3343972, 0.335903] - HW.Grad(iDevice).PaOffsetI) ./ 1;  % amplification in A/V  25-Mar-2025 09:51:39
