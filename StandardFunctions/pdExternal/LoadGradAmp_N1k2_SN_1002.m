...
%% gradient audio amplifier AmpN1k2 SN 001 (A:CH3 & B:CH4) and SN 002 (A:CH1 & B:CH2)
HW.Grad(iDevice).ExtGradSN = 001002;  % serial number
...
HW.Grad(iDevice).PaOffsetU(1:4) = [0.00, 0.01, 0.00, 0.00];  % offset voltage in V - 05-07-2024 after 30 min pre-heat
HW.Grad(iDevice).PaOffsetI(1:4) = [0, 0, 0, 0];  % offset current in A

HW.Grad(iDevice).PaUin2PaUout(1:4) = (24.55 - HW.Grad(iDevice).PaOffsetU) ./ 1;  % amplification in V/V  (data sheet: 27.6-28 dB)
