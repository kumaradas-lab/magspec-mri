...
HW.Grad(iDevice).ExtGradSN = 21;                              % serial number
...
HW.Grad(iDevice).PaOffsetI(1:4) = [-0.002355968, 0.001336827, 0.0004297138, -0.001263458];  % offset current in A, 13-May-2019 10:28:16
 
HW.Grad(iDevice).PaUin2PaIout(1:4) = ([0.3304762, 0.3344283, 0.3327338, 0.3316342] - HW.Grad(iDevice).PaOffsetI(1:4)) ./ 1;  % amplification in A/V, 13-May-2019 10:28:16
...
HW.Grad(iDevice).SystemTimeDelay(1:3) = [1.9584e-05, 1.9648e-05, 2.2192e-05];  % time delay of gradient amplifier in s with magnet #135
