%% Settings for LNA #49 21.5 MHz

% Low power broadband LNA built Mar 2023

if ~exist('iDevice', 'var'), iDevice = 1; end

HW.RX(iDevice).LnaSN = 49;
...
HW.RX(iDevice).LNAGain = 10^(((-49.2776)-(-71.24))/20);  % 21.9624 dB gain @ 21500393.0323 MHz F=1.1767 dB (-71.24 dBm cal)
