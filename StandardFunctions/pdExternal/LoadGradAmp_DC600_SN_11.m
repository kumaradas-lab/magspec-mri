...
HW.Grad(iDevice).ExtGradSN = 11;                              % serial number
...
HW.Grad(iDevice).PaOffsetI(1:4) = [0.001622965, -0.000292828, 0.006772452, -0.002820678];  % offset current in A, 07-Nov-2016 17:21:59

HW.Grad(iDevice).PaUin2PaIout(1:4) = ([0.336161, 0.3332762, 0.3393525, 0.3318368] - HW.Grad(iDevice).PaOffsetI(1:4)) ./ 1;  % amplification in A/V, 07-Nov-2016 17:23:19
