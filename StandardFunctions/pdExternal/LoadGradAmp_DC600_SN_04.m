...
HW.Grad(iDevice).ExtGradSN = 4;                               % serial number
...
HW.Grad(iDevice).PaOffsetI(1:4) = [-0.0021112, 0.002313, 0.0020685, 0.0011448];  % offset current in A

HW.Grad(iDevice).PaUin2PaIout(1:4) = ([0.3332, 0.33616, 0.33557, 0.33532] - HW.Grad(iDevice).PaOffsetI(1:4)) ./ 1;  % amplification in A/V
