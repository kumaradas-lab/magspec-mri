...
HW.Grad(iDevice).ExtGradType = 'Hoellstern';  % type of external gradient amplifier
...
HW.Grad(iDevice).PaOffsetU(1:4) = [0.00, 0.00, 0.00, 0.00];  % offset voltage in V - TODO!! 05-07-2024 after 30 min pre-heat
