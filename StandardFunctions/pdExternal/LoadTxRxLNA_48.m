...
HW.RX.LNAGain=10^(((-49.4223)-(-71.1031))/20); % 21.6808 dB gain @ 24300454.0347 MHz F=1.1289 dB (-71.1031 dBm cal)
% HW.RX.LNAGain=10^(((-49.0633)-(-70.7971))/20); % 21.7338 dB gain @ 21490393.8015 MHz F=1.3551 dB (-70.7971 dBm cal)
